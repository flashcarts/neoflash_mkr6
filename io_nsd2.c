...
IO_INTERFACE io_nsd2 = {
   DEVICE_TYPE_NSD2,
   FEATURE_MEDIUM_CANREAD | FEATURE_MEDIUM_CANWRITE | FEATURE_SLOT_GBA,
   (FN_MEDIUM_STARTUP)&NSD2_StartUp,
   (FN_MEDIUM_ISINSERTED)&NSD2_IsInserted,
   (FN_MEDIUM_READSECTORS)&NSD2_ReadSectors,
   (FN_MEDIUM_WRITESECTORS)&NSD2_WriteSectors,
   (FN_MEDIUM_CLEARSTATUS)&NSD2_ClearStatus,
   (FN_MEDIUM_SHUTDOWN)&NSD2_Shutdown
} ;
